...
class V1DiagnosticSpeedtestServersGetRequest(BaseModel):
    """
    ...
    provider: Optional[StrictStr] = Field(default=None, description="supported provider for speedtest utility")
    vrf_name: Optional[StrictStr] = Field(default=None, description="Configured VRF Name", alias="vrfName")
    __properties: ClassVar[List[str]] = ["deviceId", "provider", "vrfName"]
