...
class V1MonitoringCircuitsSummaryPostResponse(BaseModel):
    """
    V1MonitoringCircuitsSummaryPostResponse
    """ # noqa: E501
    summaries: Optional[List[StatsmonCircuitSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summaries": [StatsmonCircuitSummary.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
