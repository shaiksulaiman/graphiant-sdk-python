...
class V1PortalPrivateInventoryDetailsGetResponse(BaseModel):
    """
    V1PortalPrivateInventoryDetailsGetResponse
    """ # noqa: E501
    details: Optional[List[OnboardingPrivateGcsInventoryDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [OnboardingPrivateGcsInventoryDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
