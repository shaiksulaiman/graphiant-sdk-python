...
class AssuranceBucketAppServerList(BaseModel):
    """
    AssuranceBucketAppServerList
    """ # noqa: E501
    app: Optional[AssuranceBucketAppIdentifier] = None
    servers: Optional[List[AssuranceServer]] = None
    __properties: ClassVar[List[str]] = ["app", "servers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servers": [AssuranceServer.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None
        })
        return _obj
