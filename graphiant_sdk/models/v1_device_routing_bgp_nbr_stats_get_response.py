...
class V1DeviceRoutingBgpNbrStatsGetResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": RoutingNbrStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "token": obj.get("token")
        })
        return _obj
