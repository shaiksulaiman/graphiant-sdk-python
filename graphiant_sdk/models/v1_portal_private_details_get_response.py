...
class V1PortalPrivateDetailsGetResponse(BaseModel):
    """
    V1PortalPrivateDetailsGetResponse
    """ # noqa: E501
    details: Optional[List[OnboardingPrivateGcsDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [OnboardingPrivateGcsDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
