...
class V1SdkAutomationPlaybookJobsGetResponse(BaseModel):
    """
    V1SdkAutomationPlaybookJobsGetResponse
    """ # noqa: E501
    jobs: Optional[List[SdkAutomationPlaybookJob]] = None
    page_info: Optional[CommonPageInfo] = Field(default=None, alias="pageInfo")
    __properties: ClassVar[List[str]] = ["jobs", "pageInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [SdkAutomationPlaybookJob.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
