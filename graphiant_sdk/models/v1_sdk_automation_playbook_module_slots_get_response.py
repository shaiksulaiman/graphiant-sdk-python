...
class V1SdkAutomationPlaybookModuleSlotsGetResponse(BaseModel):
    """
    V1SdkAutomationPlaybookModuleSlotsGetResponse
    """ # noqa: E501
    modules: Optional[List[SdkAutomationCatalogModuleSlot]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modules": [SdkAutomationCatalogModuleSlot.from_dict(_item) for _item in obj["modules"]] if obj.get("modules") is not None else None
        })
        return _obj
