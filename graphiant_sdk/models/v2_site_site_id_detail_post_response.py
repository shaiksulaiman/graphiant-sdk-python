...
class V2SiteSiteIdDetailPostResponse(BaseModel):
    """
    V2SiteSiteIdDetailPostResponse
    """ # noqa: E501
    site: Optional[StatsmonV2SiteInfo] = None
    snapshots: Optional[List[GoogleProtobufTimestamp]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "site": StatsmonV2SiteInfo.from_dict(obj["site"]) if obj.get("site") is not None else None,
            "snapshots": [GoogleProtobufTimestamp.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
