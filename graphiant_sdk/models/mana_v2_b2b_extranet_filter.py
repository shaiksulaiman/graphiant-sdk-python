...
class ManaV2B2bExtranetFilter(BaseModel):
    """
    ManaV2B2bExtranetFilter
    """ # noqa: E501
    customers: Optional[List[ManaV2DomainCategory]] = None
    sites: Optional[List[ManaV2DomainCategory]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [ManaV2DomainCategory.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None,
            "sites": [ManaV2DomainCategory.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None
        })
        return _obj
