...
class V1DeviceRoutingBgpNbrsCountersGetRequest(BaseModel):
    """
    V1DeviceRoutingBgpNbrsCountersGetRequest
    """ # noqa: E501
    address: StrictStr = Field(description="BGP Nbr address (required)")
    device_id: StrictInt = Field(description="Valid configured device ID > 0 (required)", alias="deviceId")
    vrf_name: StrictStr = Field(description="Valid configured VRF name (required)", alias="vrfName")
    __properties: ClassVar[List[str]] = ["address", "deviceId", "vrfName"]
