...
class V2AssuranceFlowSummaryPostResponseEndpointDetails(BaseModel):
    """
    ...
    jitter: Optional[V2AssuranceFlowSummaryPostResponseEndpointDetailsStatistics] = None
    latency: Optional[V2AssuranceFlowSummaryPostResponseEndpointDetailsStatistics] = None
    loss: Optional[V2AssuranceFlowSummaryPostResponseEndpointDetailsStatistics] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jitter": V2AssuranceFlowSummaryPostResponseEndpointDetailsStatistics.from_dict(obj["jitter"]) if obj.get("jitter") is not None else None,
            "latency": V2AssuranceFlowSummaryPostResponseEndpointDetailsStatistics.from_dict(obj["latency"]) if obj.get("latency") is not None else None,
            "loss": V2AssuranceFlowSummaryPostResponseEndpointDetailsStatistics.from_dict(obj["loss"]) if obj.get("loss") is not None else None,
