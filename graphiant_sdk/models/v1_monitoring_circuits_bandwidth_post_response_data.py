...
class V1MonitoringCircuitsBandwidthPostResponseData(BaseModel):
    """
    V1MonitoringCircuitsBandwidthPostResponseData
    """ # noqa: E501
    selector: Optional[CommonCircuitBandwidthStatsSelector] = None
    stats: Optional[List[CommonCircuitBandwidthStats]] = None
    __properties: ClassVar[List[str]] = ["selector", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selector": CommonCircuitBandwidthStatsSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None,
            "stats": [CommonCircuitBandwidthStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
