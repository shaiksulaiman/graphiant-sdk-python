...
class V1DevicesDeviceIdStagedConfigCompareGetResponse(BaseModel):
    """
    V1DevicesDeviceIdStagedConfigCompareGetResponse
    """ # noqa: E501
    diff: Optional[StrictStr] = Field(default=None, description="The diff of latest and staged configurations in JSON patch format.")
