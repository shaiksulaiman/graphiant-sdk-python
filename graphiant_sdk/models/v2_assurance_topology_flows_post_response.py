...
class V2AssuranceTopologyFlowsPostResponse(BaseModel):
    """
    V2AssuranceTopologyFlowsPostResponse
    """ # noqa: E501
    flows: Optional[List[AssuranceApplicationFlow]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flows": [AssuranceApplicationFlow.from_dict(_item) for _item in obj["flows"]] if obj.get("flows") is not None else None
        })
        return _obj
