...
class CommonCircuitBandwidthStats(BaseModel):
    """
    CommonCircuitBandwidthStats
    """ # noqa: E501
    dl_bw_kbps: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="dlBwKbps")
    ts: Optional[GoogleProtobufTimestamp] = None
    ul_bw_kbps: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ulBwKbps")
    __properties: ClassVar[List[str]] = ["dlBwKbps", "ts", "ulBwKbps"]
