...
class V1BwtrackerRegionCloudSummaryPostResponse(BaseModel):
    """
    V1BwtrackerRegionCloudSummaryPostResponse
    """ # noqa: E501
    bwusage_summary: Optional[StatsmonBandwidthtrackerBwUsageByRegionCloudSummary] = Field(default=None, alias="bwusageSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bwusageSummary": StatsmonBandwidthtrackerBwUsageByRegionCloudSummary.from_dict(obj["bwusageSummary"]) if obj.get("bwusageSummary") is not None else None
        })
        return _obj
