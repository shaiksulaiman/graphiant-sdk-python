...
class V1AlarmHistoryGetResponse(BaseModel):
    """
    V1AlarmHistoryGetResponse
    """ # noqa: E501
    history: Optional[List[AlarmsAlarmHistory]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "history": [AlarmsAlarmHistory.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
