...
class V1GlobalDeviceStatusGetRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ipfixExportedId", "prefixSetId", "routingPolicyId", "snmpId", "syslogServerId", "trafficPolicyId"]
