...
class V1GatewaysReferenceConsumerGetRequest(BaseModel):
    """
    V1GatewaysReferenceConsumerGetRequest
    """ # noqa: E501
    customer_id: Optional[StrictInt] = Field(default=None, alias="customerId")
    lan_segment_id: Optional[StrictInt] = Field(default=None, alias="lanSegmentId")
    region_id: Optional[StrictInt] = Field(default=None, alias="regionId")
    __properties: ClassVar[List[str]] = ["customerId", "lanSegmentId", "regionId"]
