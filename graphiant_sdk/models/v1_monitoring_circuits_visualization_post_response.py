...
class V1MonitoringCircuitsVisualizationPostResponse(BaseModel):
    """
    V1MonitoringCircuitsVisualizationPostResponse
    """ # noqa: E501
    data: Optional[List[V1MonitoringCircuitsVisualizationPostResponseData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1MonitoringCircuitsVisualizationPostResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
