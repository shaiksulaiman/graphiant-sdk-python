...
class V1AlarmsListGetResponse(BaseModel):
    """
    V1AlarmsListGetResponse
    """ # noqa: E501
    alarms: Optional[List[AlarmsAlarmData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alarms": [AlarmsAlarmData.from_dict(_item) for _item in obj["alarms"]] if obj.get("alarms") is not None else None
        })
        return _obj
