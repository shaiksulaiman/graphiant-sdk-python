...
class StatsmonCircuitUtilization(BaseModel):
    """
    ...
    queue_utilization: Optional[List[StatsmonQueueUtilization]] = Field(default=None, alias="queueUtilization")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "queueUtilization": [StatsmonQueueUtilization.from_dict(_item) for _item in obj["queueUtilization"]] if obj.get("queueUtilization") is not None else None
        })
        return _obj
