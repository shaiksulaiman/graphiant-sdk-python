...
class V1MonitoringCircuitsBandwidthPostRequest(BaseModel):
    ...
    selectors: Optional[List[CommonCircuitBandwidthStatsSelector]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selectors": [CommonCircuitBandwidthStatsSelector.from_dict(_item) for _item in obj["selectors"]] if obj.get("selectors") is not None else None,
