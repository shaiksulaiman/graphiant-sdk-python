...
class V1SdkAutomationPlaybookConfigsGetResponse(BaseModel):
    """
    V1SdkAutomationPlaybookConfigsGetResponse
    """ # noqa: E501
    configs: Optional[List[SdkAutomationPlaybookConfigSummary]] = None
    page_info: Optional[CommonPageInfo] = Field(default=None, alias="pageInfo")
    __properties: ClassVar[List[str]] = ["configs", "pageInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [SdkAutomationPlaybookConfigSummary.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None,
