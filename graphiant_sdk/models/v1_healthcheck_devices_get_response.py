...
class V1HealthcheckDevicesGetResponse(BaseModel):
    """
    V1HealthcheckDevicesGetResponse
    """ # noqa: E501
    details: Optional[List[HealthcheckStatusDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [HealthcheckStatusDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
