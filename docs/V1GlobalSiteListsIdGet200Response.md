...
v1_global_site_lists_id_get200_response_instance = V1GlobalSiteListsIdGet200Response.from_json(json)
# print the JSON string representation of the object
print(V1GlobalSiteListsIdGet200Response.to_json())

# convert the object into a dict
v1_global_site_lists_id_get200_response_dict = v1_global_site_lists_id_get200_response_instance.to_dict()
# create an instance of V1GlobalSiteListsIdGet200Response from a dict
v1_global_site_lists_id_get200_response_from_dict = V1GlobalSiteListsIdGet200Response.from_dict(v1_global_site_lists_id_get200_response_dict)
```
