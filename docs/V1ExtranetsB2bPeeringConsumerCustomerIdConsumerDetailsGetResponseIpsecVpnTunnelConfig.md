...
v1_extranets_b2b_peering_consumer_customer_id_consumer_details_get_response_ipsec_vpn_tunnel_config_instance = V1ExtranetsB2bPeeringConsumerCustomerIdConsumerDetailsGetResponseIpsecVpnTunnelConfig.from_json(json)
# print the JSON string representation of the object
print(V1ExtranetsB2bPeeringConsumerCustomerIdConsumerDetailsGetResponseIpsecVpnTunnelConfig.to_json())

# convert the object into a dict
v1_extranets_b2b_peering_consumer_customer_id_consumer_details_get_response_ipsec_vpn_tunnel_config_dict = v1_extranets_b2b_peering_consumer_customer_id_consumer_details_get_response_ipsec_vpn_tunnel_config_instance.to_dict()
# create an instance of V1ExtranetsB2bPeeringConsumerCustomerIdConsumerDetailsGetResponseIpsecVpnTunnelConfig from a dict
v1_extranets_b2b_peering_consumer_customer_id_consumer_details_get_response_ipsec_vpn_tunnel_config_from_dict = V1ExtranetsB2bPeeringConsumerCustomerIdConsumerDetailsGetResponseIpsecVpnTunnelConfig.from_dict(v1_extranets_b2b_peering_consumer_customer_id_consumer_details_get_response_ipsec_vpn_tunnel_config_dict)
```
