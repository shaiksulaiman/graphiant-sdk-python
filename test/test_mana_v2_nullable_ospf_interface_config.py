...
class TestManaV2NullableOspfInterfaceConfig(unittest.TestCase):
    """ManaV2NullableOspfInterfaceConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableOspfInterfaceConfig:
        """Test ManaV2NullableOspfInterfaceConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableOspfInterfaceConfig`
        """
        model = ManaV2NullableOspfInterfaceConfig()
        if include_optional:
            return ManaV2NullableOspfInterfaceConfig(
    ...
    def testManaV2NullableOspfInterfaceConfig(self):
        """Test ManaV2NullableOspfInterfaceConfig"""
