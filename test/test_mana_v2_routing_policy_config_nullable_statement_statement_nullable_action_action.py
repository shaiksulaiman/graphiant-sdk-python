...
class TestManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction(unittest.TestCase):
    """ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction:
        """Test ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction`
        """
        model = ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction()
        if include_optional:
            return ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction(
    ...
    def testManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction(self):
        """Test ManaV2RoutingPolicyConfigNullableStatementStatementNullableActionAction"""
