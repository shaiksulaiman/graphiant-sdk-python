...
class TestV1LanSegmentsGetResponse(unittest.TestCase):
    """V1LanSegmentsGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1LanSegmentsGetResponse:
        """Test V1LanSegmentsGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1LanSegmentsGetResponse`
        """
        model = V1LanSegmentsGetResponse()
        if include_optional:
    ...
    def testV1LanSegmentsGetResponse(self):
        """Test V1LanSegmentsGetResponse"""
