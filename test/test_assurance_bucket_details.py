...
class TestAssuranceBucketDetails(unittest.TestCase):
    """AssuranceBucketDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssuranceBucketDetails:
        """Test AssuranceBucketDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssuranceBucketDetails`
        """
        model = AssuranceBucketDetails()
        if include_optional:
            return AssuranceBucketDetails(
    ...
    def testAssuranceBucketDetails(self):
        """Test AssuranceBucketDetails"""
