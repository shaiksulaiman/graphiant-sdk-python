...
class TestManaV2DhcpSubnetConfig(unittest.TestCase):
    """ManaV2DhcpSubnetConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2DhcpSubnetConfig:
        """Test ManaV2DhcpSubnetConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2DhcpSubnetConfig`
        """
        model = ManaV2DhcpSubnetConfig()
        if include_optional:
            return ManaV2DhcpSubnetConfig(
    ...
    def testManaV2DhcpSubnetConfig(self):
        """Test ManaV2DhcpSubnetConfig"""
