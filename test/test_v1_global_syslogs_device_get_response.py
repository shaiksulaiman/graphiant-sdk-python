...
class TestV1GlobalSyslogsDeviceGetResponse(unittest.TestCase):
    """V1GlobalSyslogsDeviceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalSyslogsDeviceGetResponse:
        """Test V1GlobalSyslogsDeviceGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalSyslogsDeviceGetResponse`
        """
        model = V1GlobalSyslogsDeviceGetResponse()
        if include_optional:
    ...
    def testV1GlobalSyslogsDeviceGetResponse(self):
        """Test V1GlobalSyslogsDeviceGetResponse"""
