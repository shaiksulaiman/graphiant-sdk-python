...
class TestV1GlobalRoutingPoliciesPostResponse(unittest.TestCase):
    """V1GlobalRoutingPoliciesPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalRoutingPoliciesPostResponse:
        """Test V1GlobalRoutingPoliciesPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalRoutingPoliciesPostResponse`
        """
        model = V1GlobalRoutingPoliciesPostResponse()
        if include_optional:
    ...
    def testV1GlobalRoutingPoliciesPostResponse(self):
        """Test V1GlobalRoutingPoliciesPostResponse"""
