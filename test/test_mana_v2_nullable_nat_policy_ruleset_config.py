...
class TestManaV2NullableNatPolicyRulesetConfig(unittest.TestCase):
    """ManaV2NullableNatPolicyRulesetConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableNatPolicyRulesetConfig:
        """Test ManaV2NullableNatPolicyRulesetConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableNatPolicyRulesetConfig`
        """
        model = ManaV2NullableNatPolicyRulesetConfig()
        if include_optional:
            return ManaV2NullableNatPolicyRulesetConfig(
    ...
    def testManaV2NullableNatPolicyRulesetConfig(self):
        """Test ManaV2NullableNatPolicyRulesetConfig"""
