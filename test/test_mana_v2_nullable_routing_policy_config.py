...
class TestManaV2NullableRoutingPolicyConfig(unittest.TestCase):
    """ManaV2NullableRoutingPolicyConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableRoutingPolicyConfig:
        """Test ManaV2NullableRoutingPolicyConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableRoutingPolicyConfig`
        """
        model = ManaV2NullableRoutingPolicyConfig()
        if include_optional:
            return ManaV2NullableRoutingPolicyConfig(
    ...
    def testManaV2NullableRoutingPolicyConfig(self):
        """Test ManaV2NullableRoutingPolicyConfig"""
