...
class TestAlertserviceAlertRecord(unittest.TestCase):
    """AlertserviceAlertRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlertserviceAlertRecord:
        """Test AlertserviceAlertRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlertserviceAlertRecord`
        """
        model = AlertserviceAlertRecord()
        if include_optional:
            return AlertserviceAlertRecord(
                acknowledged_list = [
                    'example string'
                    ],
    ...
    def testAlertserviceAlertRecord(self):
        """Test AlertserviceAlertRecord"""
