...
class TestV1GatewaysReferenceConsumerGetResponse(unittest.TestCase):
    """V1GatewaysReferenceConsumerGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GatewaysReferenceConsumerGetResponse:
        """Test V1GatewaysReferenceConsumerGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GatewaysReferenceConsumerGetResponse`
        """
        model = V1GatewaysReferenceConsumerGetResponse()
        if include_optional:
    ...
    def testV1GatewaysReferenceConsumerGetResponse(self):
        """Test V1GatewaysReferenceConsumerGetResponse"""
