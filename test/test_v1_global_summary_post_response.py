...
class TestV1GlobalSummaryPostResponse(unittest.TestCase):
    """V1GlobalSummaryPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalSummaryPostResponse:
        """Test V1GlobalSummaryPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalSummaryPostResponse`
        """
        model = V1GlobalSummaryPostResponse()
        if include_optional:
    ...
    def testV1GlobalSummaryPostResponse(self):
        """Test V1GlobalSummaryPostResponse"""
