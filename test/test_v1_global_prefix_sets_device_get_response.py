...
class TestV1GlobalPrefixSetsDeviceGetResponse(unittest.TestCase):
    """V1GlobalPrefixSetsDeviceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalPrefixSetsDeviceGetResponse:
        """Test V1GlobalPrefixSetsDeviceGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalPrefixSetsDeviceGetResponse`
        """
        model = V1GlobalPrefixSetsDeviceGetResponse()
        if include_optional:
    ...
    def testV1GlobalPrefixSetsDeviceGetResponse(self):
        """Test V1GlobalPrefixSetsDeviceGetResponse"""
