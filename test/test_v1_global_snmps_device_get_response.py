...
class TestV1GlobalSnmpsDeviceGetResponse(unittest.TestCase):
    """V1GlobalSnmpsDeviceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalSnmpsDeviceGetResponse:
        """Test V1GlobalSnmpsDeviceGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalSnmpsDeviceGetResponse`
        """
        model = V1GlobalSnmpsDeviceGetResponse()
        if include_optional:
    ...
    def testV1GlobalSnmpsDeviceGetResponse(self):
        """Test V1GlobalSnmpsDeviceGetResponse"""
