...
class TestManaV2NullableBgpNeighborConfig(unittest.TestCase):
    """ManaV2NullableBgpNeighborConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableBgpNeighborConfig:
        """Test ManaV2NullableBgpNeighborConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableBgpNeighborConfig`
        """
        model = ManaV2NullableBgpNeighborConfig()
        if include_optional:
            return ManaV2NullableBgpNeighborConfig(
    ...
    def testManaV2NullableBgpNeighborConfig(self):
        """Test ManaV2NullableBgpNeighborConfig"""
