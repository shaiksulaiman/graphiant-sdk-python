...
class TestManaV2DeviceSnapshotList(unittest.TestCase):
    """ManaV2DeviceSnapshotList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2DeviceSnapshotList:
        """Test ManaV2DeviceSnapshotList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2DeviceSnapshotList`
        """
        model = ManaV2DeviceSnapshotList()
        if include_optional:
            return ManaV2DeviceSnapshotList(
                count = 123,
                snapshots = [
    ...
    def testManaV2DeviceSnapshotList(self):
        """Test ManaV2DeviceSnapshotList"""
