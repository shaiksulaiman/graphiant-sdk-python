...
class TestV1SitesSiteIdCircuitsGetResponseData(unittest.TestCase):
    """V1SitesSiteIdCircuitsGetResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1SitesSiteIdCircuitsGetResponseData:
        """Test V1SitesSiteIdCircuitsGetResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1SitesSiteIdCircuitsGetResponseData`
        """
        model = V1SitesSiteIdCircuitsGetResponseData()
        if include_optional:
            return V1SitesSiteIdCircuitsGetResponseData(
                circuits = [
    ...
    def testV1SitesSiteIdCircuitsGetResponseData(self):
        """Test V1SitesSiteIdCircuitsGetResponseData"""
