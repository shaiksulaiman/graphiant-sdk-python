...
class TestManaV2GuestConsumerSiteToSiteVpnConfig(unittest.TestCase):
    """ManaV2GuestConsumerSiteToSiteVpnConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2GuestConsumerSiteToSiteVpnConfig:
        """Test ManaV2GuestConsumerSiteToSiteVpnConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2GuestConsumerSiteToSiteVpnConfig`
        """
        model = ManaV2GuestConsumerSiteToSiteVpnConfig()
        if include_optional:
            return ManaV2GuestConsumerSiteToSiteVpnConfig(
                emails = [
                    'example string'
                    ],
    ...
    def testManaV2GuestConsumerSiteToSiteVpnConfig(self):
        """Test ManaV2GuestConsumerSiteToSiteVpnConfig"""
