...
class TestManaV2Snmp(unittest.TestCase):
    """ManaV2Snmp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2Snmp:
        """Test ManaV2Snmp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2Snmp`
        """
        model = ManaV2Snmp()
        if include_optional:
            return ManaV2Snmp(
