...
class TestManaV2RoutingPolicyConfig(unittest.TestCase):
    """ManaV2RoutingPolicyConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2RoutingPolicyConfig:
        """Test ManaV2RoutingPolicyConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2RoutingPolicyConfig`
        """
        model = ManaV2RoutingPolicyConfig()
        if include_optional:
            return ManaV2RoutingPolicyConfig(
    ...
    def testManaV2RoutingPolicyConfig(self):
        """Test ManaV2RoutingPolicyConfig"""
