...
class TestManaV2Vrf(unittest.TestCase):
    """ManaV2Vrf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2Vrf:
        """Test ManaV2Vrf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2Vrf`
        """
        model = ManaV2Vrf()
        if include_optional:
            return ManaV2Vrf(
