...
class TestManaV2OspFv3Process(unittest.TestCase):
    """ManaV2OspFv3Process unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2OspFv3Process:
        """Test ManaV2OspFv3Process
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2OspFv3Process`
        """
        model = ManaV2OspFv3Process()
        if include_optional:
            return ManaV2OspFv3Process(
                admin_distance = 100,
                areas = [
    ...
    def testManaV2OspFv3Process(self):
        """Test ManaV2OspFv3Process"""
