...
class TestV1GlobalPrefixSetsSiteGetResponse(unittest.TestCase):
    """V1GlobalPrefixSetsSiteGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalPrefixSetsSiteGetResponse:
        """Test V1GlobalPrefixSetsSiteGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalPrefixSetsSiteGetResponse`
        """
        model = V1GlobalPrefixSetsSiteGetResponse()
        if include_optional:
    ...
    def testV1GlobalPrefixSetsSiteGetResponse(self):
        """Test V1GlobalPrefixSetsSiteGetResponse"""
