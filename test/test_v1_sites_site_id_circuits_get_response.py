...
class TestV1SitesSiteIdCircuitsGetResponse(unittest.TestCase):
    """V1SitesSiteIdCircuitsGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1SitesSiteIdCircuitsGetResponse:
        """Test V1SitesSiteIdCircuitsGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1SitesSiteIdCircuitsGetResponse`
        """
        model = V1SitesSiteIdCircuitsGetResponse()
        if include_optional:
            return V1SitesSiteIdCircuitsGetResponse(
                data = [
                    graphiant_sdk.models.v1_sites_site_id_circuits_get_response_data.v1SitesSiteIdCircuitsGetResponseData(
                        circuits = [
    ...
    def testV1SitesSiteIdCircuitsGetResponse(self):
        """Test V1SitesSiteIdCircuitsGetResponse"""
