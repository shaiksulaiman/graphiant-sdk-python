...
class TestAssuranceAppNameRecord(unittest.TestCase):
    """AssuranceAppNameRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssuranceAppNameRecord:
        """Test AssuranceAppNameRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssuranceAppNameRecord`
        """
        model = AssuranceAppNameRecord()
        if include_optional:
            return AssuranceAppNameRecord(
    ...
    def testAssuranceAppNameRecord(self):
        """Test AssuranceAppNameRecord"""
