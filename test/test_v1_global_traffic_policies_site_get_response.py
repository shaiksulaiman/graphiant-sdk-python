...
class TestV1GlobalTrafficPoliciesSiteGetResponse(unittest.TestCase):
    """V1GlobalTrafficPoliciesSiteGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalTrafficPoliciesSiteGetResponse:
        """Test V1GlobalTrafficPoliciesSiteGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalTrafficPoliciesSiteGetResponse`
        """
        model = V1GlobalTrafficPoliciesSiteGetResponse()
        if include_optional:
    ...
    def testV1GlobalTrafficPoliciesSiteGetResponse(self):
        """Test V1GlobalTrafficPoliciesSiteGetResponse"""
