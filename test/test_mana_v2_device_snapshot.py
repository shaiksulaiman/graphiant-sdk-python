...
class TestManaV2DeviceSnapshot(unittest.TestCase):
    """ManaV2DeviceSnapshot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2DeviceSnapshot:
        """Test ManaV2DeviceSnapshot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2DeviceSnapshot`
        """
        model = ManaV2DeviceSnapshot()
        if include_optional:
            return ManaV2DeviceSnapshot(
    ...
    def testManaV2DeviceSnapshot(self):
        """Test ManaV2DeviceSnapshot"""
