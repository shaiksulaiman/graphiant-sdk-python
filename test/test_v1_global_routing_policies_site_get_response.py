...
class TestV1GlobalRoutingPoliciesSiteGetResponse(unittest.TestCase):
    """V1GlobalRoutingPoliciesSiteGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalRoutingPoliciesSiteGetResponse:
        """Test V1GlobalRoutingPoliciesSiteGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalRoutingPoliciesSiteGetResponse`
        """
        model = V1GlobalRoutingPoliciesSiteGetResponse()
        if include_optional:
    ...
    def testV1GlobalRoutingPoliciesSiteGetResponse(self):
        """Test V1GlobalRoutingPoliciesSiteGetResponse"""
