...
class TestV1GlobalTrafficPoliciesPostResponse(unittest.TestCase):
    """V1GlobalTrafficPoliciesPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalTrafficPoliciesPostResponse:
        """Test V1GlobalTrafficPoliciesPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalTrafficPoliciesPostResponse`
        """
        model = V1GlobalTrafficPoliciesPostResponse()
        if include_optional:
    ...
    def testV1GlobalTrafficPoliciesPostResponse(self):
        """Test V1GlobalTrafficPoliciesPostResponse"""
