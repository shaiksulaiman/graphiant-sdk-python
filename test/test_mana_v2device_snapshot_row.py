...
class TestManaV2deviceSnapshotRow(unittest.TestCase):
    """ManaV2deviceSnapshotRow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2deviceSnapshotRow:
        """Test ManaV2deviceSnapshotRow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2deviceSnapshotRow`
        """
        model = ManaV2deviceSnapshotRow()
        if include_optional:
            return ManaV2deviceSnapshotRow(
    ...
    def testManaV2deviceSnapshotRow(self):
        """Test ManaV2deviceSnapshotRow"""
