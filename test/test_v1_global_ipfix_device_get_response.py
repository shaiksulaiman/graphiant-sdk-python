...
class TestV1GlobalIpfixDeviceGetResponse(unittest.TestCase):
    """V1GlobalIpfixDeviceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalIpfixDeviceGetResponse:
        """Test V1GlobalIpfixDeviceGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalIpfixDeviceGetResponse`
        """
        model = V1GlobalIpfixDeviceGetResponse()
        if include_optional:
    ...
    def testV1GlobalIpfixDeviceGetResponse(self):
        """Test V1GlobalIpfixDeviceGetResponse"""
