...
class TestManaV2NullableOspfAreaConfig(unittest.TestCase):
    """ManaV2NullableOspfAreaConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableOspfAreaConfig:
        """Test ManaV2NullableOspfAreaConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableOspfAreaConfig`
        """
        model = ManaV2NullableOspfAreaConfig()
        if include_optional:
            return ManaV2NullableOspfAreaConfig(
    ...
    def testManaV2NullableOspfAreaConfig(self):
        """Test ManaV2NullableOspfAreaConfig"""
