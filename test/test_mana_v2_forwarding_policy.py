...
class TestManaV2ForwardingPolicy(unittest.TestCase):
    """ManaV2ForwardingPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2ForwardingPolicy:
        """Test ManaV2ForwardingPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2ForwardingPolicy`
        """
        model = ManaV2ForwardingPolicy()
        if include_optional:
            return ManaV2ForwardingPolicy(
                dpi_applications = [
    ...
    def testManaV2ForwardingPolicy(self):
        """Test ManaV2ForwardingPolicy"""
