...
class TestManaV2NullableOspfProcessConfig(unittest.TestCase):
    """ManaV2NullableOspfProcessConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableOspfProcessConfig:
        """Test ManaV2NullableOspfProcessConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableOspfProcessConfig`
        """
        model = ManaV2NullableOspfProcessConfig()
        if include_optional:
            return ManaV2NullableOspfProcessConfig(
    ...
    def testManaV2NullableOspfProcessConfig(self):
        """Test ManaV2NullableOspfProcessConfig"""
