...
class TestV1GlobalSnmpsSiteGetResponse(unittest.TestCase):
    """V1GlobalSnmpsSiteGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalSnmpsSiteGetResponse:
        """Test V1GlobalSnmpsSiteGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalSnmpsSiteGetResponse`
        """
        model = V1GlobalSnmpsSiteGetResponse()
        if include_optional:
    ...
    def testV1GlobalSnmpsSiteGetResponse(self):
        """Test V1GlobalSnmpsSiteGetResponse"""
