...
class TestManaV2IpfixExporter(unittest.TestCase):
    """ManaV2IpfixExporter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2IpfixExporter:
        """Test ManaV2IpfixExporter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2IpfixExporter`
        """
        model = ManaV2IpfixExporter()
        if include_optional:
            return ManaV2IpfixExporter(
    ...
    def testManaV2IpfixExporter(self):
        """Test ManaV2IpfixExporter"""
