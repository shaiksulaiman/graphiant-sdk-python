...
class TestManaV2RoutingPolicyConfigNullableStatementStatement(unittest.TestCase):
    """ManaV2RoutingPolicyConfigNullableStatementStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2RoutingPolicyConfigNullableStatementStatement:
        """Test ManaV2RoutingPolicyConfigNullableStatementStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2RoutingPolicyConfigNullableStatementStatement`
        """
        model = ManaV2RoutingPolicyConfigNullableStatementStatement()
        if include_optional:
            return ManaV2RoutingPolicyConfigNullableStatementStatement(
                actions = {
    ...
    def testManaV2RoutingPolicyConfigNullableStatementStatement(self):
        """Test ManaV2RoutingPolicyConfigNullableStatementStatement"""
