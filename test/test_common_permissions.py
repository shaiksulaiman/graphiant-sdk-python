...
class TestCommonPermissions(unittest.TestCase):
    """CommonPermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommonPermissions:
        """Test CommonPermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonPermissions`
        """
        model = CommonPermissions()
        if include_optional:
    ...
    def testCommonPermissions(self):
        """Test CommonPermissions"""
