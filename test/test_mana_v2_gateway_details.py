...
class TestManaV2GatewayDetails(unittest.TestCase):
    """ManaV2GatewayDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2GatewayDetails:
        """Test ManaV2GatewayDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2GatewayDetails`
        """
        model = ManaV2GatewayDetails()
        if include_optional:
            return ManaV2GatewayDetails(
    ...
    def testManaV2GatewayDetails(self):
        """Test ManaV2GatewayDetails"""
