...
class TestManaV2OspfInterface(unittest.TestCase):
    """ManaV2OspfInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2OspfInterface:
        """Test ManaV2OspfInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2OspfInterface`
        """
        model = ManaV2OspfInterface()
        if include_optional:
            return ManaV2OspfInterface(
    ...
    def testManaV2OspfInterface(self):
        """Test ManaV2OspfInterface"""
