...
class TestV2ChildalertlistPostResponse(unittest.TestCase):
    """V2ChildalertlistPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ChildalertlistPostResponse:
        """Test V2ChildalertlistPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ChildalertlistPostResponse`
        """
        model = V2ChildalertlistPostResponse()
        if include_optional:
    ...
    def testV2ChildalertlistPostResponse(self):
        """Test V2ChildalertlistPostResponse"""
