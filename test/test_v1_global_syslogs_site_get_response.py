...
class TestV1GlobalSyslogsSiteGetResponse(unittest.TestCase):
    """V1GlobalSyslogsSiteGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalSyslogsSiteGetResponse:
        """Test V1GlobalSyslogsSiteGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalSyslogsSiteGetResponse`
        """
        model = V1GlobalSyslogsSiteGetResponse()
        if include_optional:
    ...
    def testV1GlobalSyslogsSiteGetResponse(self):
        """Test V1GlobalSyslogsSiteGetResponse"""
