...
class TestV1DevicesDeviceIdEdgesGetResponse(unittest.TestCase):
    """V1DevicesDeviceIdEdgesGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdEdgesGetResponse:
        """Test V1DevicesDeviceIdEdgesGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdEdgesGetResponse`
        """
        model = V1DevicesDeviceIdEdgesGetResponse()
        if include_optional:
    ...
    def testV1DevicesDeviceIdEdgesGetResponse(self):
        """Test V1DevicesDeviceIdEdgesGetResponse"""
