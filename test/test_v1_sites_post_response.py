...
class TestV1SitesPostResponse(unittest.TestCase):
    """V1SitesPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1SitesPostResponse:
        """Test V1SitesPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1SitesPostResponse`
        """
        model = V1SitesPostResponse()
        if include_optional:
    ...
    def testV1SitesPostResponse(self):
        """Test V1SitesPostResponse"""
